...
HD_PWD='C:/Users/Rockefeller157/Desktop/VHDL/FPGA-M1/Central_DCC/Central_DCC/Central_DCC.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log central_design_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source central_design_wrapper.tcl
