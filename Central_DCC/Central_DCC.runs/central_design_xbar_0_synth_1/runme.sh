...
HD_PWD='C:/Central_DCC/Central_DCC/Central_DCC.runs/central_design_xbar_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log central_design_xbar_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source central_design_xbar_0.tcl
