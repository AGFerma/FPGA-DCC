...
HD_PWD='C:/Users/Rockefeller157/Desktop/VHDL/FPGA-M1/Central_DCC/Central_DCC/Central_DCC.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log central_design_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source central_design_wrapper.tcl -notrace
