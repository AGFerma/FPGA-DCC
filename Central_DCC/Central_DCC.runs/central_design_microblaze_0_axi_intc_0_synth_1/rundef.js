...
ISEStep( "vivado",
         "-log central_design_microblaze_0_axi_intc_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source central_design_microblaze_0_axi_intc_0.tcl" );
